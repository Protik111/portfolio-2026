export const productCardDetails = [
  {
    ...
    description:
      "I develop responsive, visually appealing, and highly functional web applications using the latest frontend technologies.",
    svgIcon: (
      <svg
  ...
  },
  {
    ...
    description:
      "I develop scalable, high-performance cloud-based backend services to efficiently support and host your applications for all users.",
    svgIcon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
