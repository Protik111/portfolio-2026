...
const ctaLinks = [
  ...
  {
    href: "https://leetcode.com/protik111",
    label: "LeetCode",
  ...
  // {
  //   href: "https://stackoverflow.com/users/16166513/rafiur-rahman-protik",
  //   label: "StackOverflow",
  //   icon: <FaStackOverflow size={16} color="#f48024" />,
  //   iconBg: "rgba(244,128,36,0.12)",
  //   target: "_blank",
  // },
  {
      ...
      <div className="container-narrow">
        ...
        <div className="mb-8 text-[15.5px] leading-[1.8] text-fg">
          <p className="mb-4">
            ...
            production-ready applications and cloud-native solutions. My
            expertise spans{" "}
            <strong>
              React.js, Next.js, TypeScript, Node.js, Docker, AWS, CI/CD, and
              microservices architecture
            </strong>
            .
          </p>
          <p className="mb-5">
            I focus on solving real-world problems with clean code, scalable
            design, and cost-efficient cloud solutions. From video streaming
            platforms to containerized microservices, I enjoy tackling complex
            technical challenges and building systems that scale.
          </p>
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3 pb-1">
            {ctaLinks.map(({ href, label, icon, iconBg, target }) => (
              <a
                ...
                className="btn-neo shrink-0 gap-2 whitespace-nowrap rounded-[10px] py-[7px] pr-[14px] pl-[7px] font-medium"
              >
                <span
        ...
        <div className="mt-14 flex flex-col gap-6 pb-8">
          {/* Terminal Card */}
          <div
            className="overflow-hidden rounded-[10px] border border-border font-mono shadow-[0_4px_12px_rgba(0,0,0,0.05)]"
          ...
          >
            ...
            >
              ...
              />
              <div className="ml-2.5 text-xs" style={{ color: "#8b949e" }}>
                protik@env: ~
              </div>
            </div>
            <div
              className="overflow-x-auto p-5 text-[13.5px] leading-[1.7]"
              style={{ color: "#c9d1d9" }}
            >
              <p className="mb-2">
              ...
              <p className="mb-2">
                <span style={{ color: "#7ee787" }}>$</span> ./deploy --env
                production
              </p>
          ...
          <div className="flex flex-col gap-4 rounded-[10px] border border-border bg-card-bg p-6">
            ...
            <div className="text-[14.5px] leading-[1.6] text-muted">
              <p className="mb-2">
                <strong className="text-fg">✓</strong> Actively building
                scalable microservices and cloud-native solutions.
              </p>
              <p className="mb-2">
                <strong className="text-fg">✓</strong> Exploring event-driven
                architectures with RabbitMQ.
              </p>
              <p className="m-0">
                <strong className="text-fg">✓</strong> Architecting highly
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(140px,1fr))] gap-4">
            {statCards.map((stat) => (
              ...
              >
                ...
                <div className="text-[13px] tracking-wide text-muted uppercase">
                  {stat.label}
                </div>
              </div>
            ))}
